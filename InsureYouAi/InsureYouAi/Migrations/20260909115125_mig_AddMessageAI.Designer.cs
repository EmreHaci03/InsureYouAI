...
namespace InsureYouAi.Migrations
{
    ...
    [Migration("20260909115125_mig_AddMessageAI")]
    partial class mig_AddMessageAI
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InsureYouAi.Entities.AppRole", b =>
                {
            ...
            modelBuilder.Entity("InsureYouAi.Entities.MessageReply", b =>
                {
                    b.Property<int>("MessageReplyId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("MessageReplyId"));
            ...
            modelBuilder.Entity("InsureYouAi.Entities.MessageReply", b =>
                {
                    b.HasOne("InsureYouAi.Entities.Message", "Message")
            ...
            modelBuilder.Entity("InsureYouAi.Entities.Policy", b =>
                {
                    b.HasOne("InsureYouAi.Entities.AppUser", "User")
                        .WithMany("Policies")
                        .HasForeignKey("AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("InsureYouAi.Entities.AppRole", null)
                        .WithMany()
